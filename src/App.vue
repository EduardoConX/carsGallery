    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div v-else>
        <input type="text"
          ...
          placeholder="Search" :value="searchQuery" @input="
            (e) => {
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          <div v-for="(car, index) in currentCars" :key="index" class="bg-gray-800 rounded-lg overflow-hidden">
        ...
        <div v-if="totalPages > 1" class="flex justify-center mt-12 space-x-2">
          <PaginationButton @click="handlePageChange(currentPage - 1)" :is-disabled="currentPage === 1" text="Prev" />
          <PaginationButton @click="handlePageChange(currentPage + 1)" :is-disabled="currentPage === totalPages"
            text="Next" />
